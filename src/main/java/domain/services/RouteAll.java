...
public class RouteAll extends HttpServlet {
		...
		//	System.out.println("Full place");
			...
			if(data.has("route"))           {
				...
				HiberCritiria HiberCritiria = new HiberCritiria();
			  	List <RouteDto> routes =  RouteDao.findbyRoutetrackingAll();
				    ...
				    if (routes.isEmpty()) {
				    	...
				    	for (int i = routes.size() - 1 ; i >= 0 ; i--) {
	                        ...
	                        try {
	                            ...
	                            eachData.put("Route",routes.get(i).getRoute());
	                            eachData.put("RouteTracking",routes.get(i).getRoutetracking());
